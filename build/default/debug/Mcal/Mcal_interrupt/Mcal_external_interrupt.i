# 1 "Mcal/Mcal_interrupt/Mcal_external_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Mcal/Mcal_interrupt/Mcal_external_interrupt.c" 2
...
# 1 "Mcal/Mcal_interrupt/../Mcal_Compiler.h" 1
# 12 "Mcal/Mcal_interrupt/../Mcal_Compiler.h"
...
# 12 "Mcal/Mcal_interrupt/../Mcal_Compiler.h" 2
# 14 "Mcal/Mcal_interrupt/../Mcal_Std_Types.h" 2

# 1 "Mcal/Mcal_interrupt/../Mcal_Bit_Math.h" 1
...
Std_Return MCAL_INTERRUPT_RBx_init(const Interrupt_RBx_t *copyRBx) {
    ...
    if(copyRBx == ((void*)0)) {
        ...
        (INTCONbits.RBIE = 0);
        (INTCONbits.RBIF = 0);
# 247 "Mcal/Mcal_interrupt/Mcal_external_interrupt.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 314 "Mcal/Mcal_interrupt/Mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
# 329 "Mcal/Mcal_interrupt/Mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
# 402 "Mcal/Mcal_interrupt/Mcal_external_interrupt.c"
static Std_Return INTERRUPT_INTx_EdgInit(const Interrupt_INTx_t *copyINTx) {
    uint8_t retValue = (Std_Return)0;
    if(copyINTx == ((void*)0)) {
        retValue = (Std_Return)0;
